        ...
        public function store(Request $request)
          {
            ...
            $permissions = $request->input('permission');
                if (!is_array($permissions)) {
                    $permissions = [$permissions]; // Convertir en array si no lo es
                }

                $role = Role::create(['name' => $request->input('name'), 'guard_name' => $request->input('guard') ]);
                            //   $role->syncPermissions($request->input('permission'), $request->input('guard'));
    ...
    public function update(Request $request, $id)
        {
            ...
            $this->validate($request, [
                'name' => 'required',
                'permission' => 'required|array', // Verificar que sea un array
            ]);
            ...
            $role->guard_name = 'web'; // Asignar guard_name como 'web'
            $role->save();
