...
@section('title', 'Cotizaciones Autorizadas')
...
@section('content')
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped table-borderless border-bottom pb-4">
                    <thead>
                        <form method="GET" action="{{ route('cotizaciones-cotisliberadas') }}" id="search-form">
                            <tr>
                                    ...
                                    <div class="d-flex ">
                                        <div class="text-center">
                                         ...
                                         <a type="button" class="btn btn-info me-4 p-1 "
                                            href="{{ route('cotizaciones-completas', $requisicion->id) }}">
                                            Ver / Subir Factura
                                        </a>
                                        ...
                                        <div class="text-center">
                                              @if (in_array('recursos_materiales', $userRole) && $requisicion->estado == 10)
    ...
    <form id="formEntregado" action="{{ route('cotizaciones-entregado') }}" method="post">
        @csrf
