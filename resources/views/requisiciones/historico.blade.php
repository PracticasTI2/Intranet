...
@section('content')
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="d-flex justify-content-end m-2">
                <span class="">
                    <a href="{{ route('requisiciones-historialproductos') }}" class="btn btn-info mx-4 p-2 m-2">Ver por
                        descripción</a>
                </span>
                <span class="">
                                ...
                                <th class="mt-2 pt-2">Tipo
                                    <div class="">
                                        <input type="text" name="tipo" placeholder="tipo..."
                                            value="{{ request('tipo') }}" autocomplete="off"
                                            class="form-control text-xs mt-2" />
                                    </div>
                                </th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($requisicion->idtipo_insumo == 1)
                                        <p class="text-warning">Consumibles</p>
                                    @else
                                        <p class="text-info">Especiales</p>
                                    @endif
                                </td>

                                <td>
                                    <div class="d-flex">
                                        <a type="button" class="btn btn-link border border-primary me-4 p-2"
    ...
    <script>
        ...
        document.querySelectorAll(
            'input[name="empresa"], input[name="solicitante"], input[name="area"], input[name="estatus"], input[name="fecha"], input[name="tipo"], input[name="folio"]'
