    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                @if( (in_array('contralor', $userRole) || in_array('encargado', $userRole)) && $requisiciones->diagnostico)
                    <div class="col-md-6 p-2 m-3 ">

                        <a href="{{ route('view-cotizacion', ['file' => $requisiciones->diagnostico]) }}"
                                                class="btn btn-lg btn-info " target="_blank">Ver Diagnostico</a>
                    </div>
                @endif
                    ...
                    <table class="table table-striped table-borderless border-bottom p-2">
                       ...
                       <tbody>
                            @foreach ($cotizaciones as $cotizacion)
                                ...
                                @elseif(!in_array('recursos_materiales', $userRole) && $cotizacion->estatus == 1)
                                    <!-- Solo se mostrarán las cotizaciones con estatus = 1 para el rol "recursos_materiales" -->
                                    <tr>
                                        <td>{{ $cotizacion->id }}</td>
                                        <td>{{ $cotizacion->archivo }}</td>
                                ...
                                @elseif (!in_array('recursos_materiales', $userRole) && $requisiciones->estado == 7 && $requisiciones->estado == 10)
                            ...
                            <form id="formAutorizar" action="{{ route('requisiciones-autorizar') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="estado" id="estado" required>
                                        ...
                                        @if (in_array('contralor', $userRole) || in_array('autorizainsumos', $userRole))
                                            <option value="2" {{ old('estado') == '2' ? 'selected' : '' }}>Autorizado Sin Cotizar
                                            </option>
                                        @endif

                                         @if (in_array('contralor', $userRole) )
                                            <option value="9" {{ old('estado') == '4' ? 'selected' : '' }}>Autorizado  y Solicitar Cotizacion
                                            </option>
                                        @endif
