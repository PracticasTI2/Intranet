    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="d-flex justify-content-end m-2">
                <span class="">
                    <a href="{{route('permisos-create')}}" class="btn btn-primary">Agregar Permisos</a>
                </span>
            </div>
                        ...
                        <form method="GET" action="#" id="search-form">
                            <tr>
                                ...
                                <th class="mt-2 pt-2">Nombre
                                    <div class="">
                                        <input type="text" name="nombre" placeholder="permisos..." value="{{ request('nombre') }}" autocomplete="off" class="form-control text-xs mt-2 "/>
                                    </div>
                                </th>
                                ...
                                <td>
                                    <div class="" style="display: flex;">
                                        <span class="  d-inline m-2" style="white-space: nowrap; ">
                                            <a href="{{ route('permisos-show', ['id' => $per->id]) }}" class="btn btn-secondary text-white">
                                                <i class='bx bxs-show'></i>
                                            </a>
                                        </span>
                                        <span class=" d-inline m-2"  style="white-space: nowrap; ">
                                            <a href="{{ route('permisos-edit', ['id' => $per->id]) }}" class="btn btn-primary text-white">
        ...
        function confirmDelete(nombre, idRol) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'POST';
                    form.action = '{{ route('permisos-destroy', ':id') }}'.replace(':id', idRol);
