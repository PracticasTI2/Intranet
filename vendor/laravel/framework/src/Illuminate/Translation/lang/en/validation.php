...
return [
    ...
    */
    ...
    | especificar un mensaje de idioma personalizado para una regla de atributo determinada.
    |
    */
    ...
    | con algo más legible, como "Dirección de correo electrónico" en lugar
